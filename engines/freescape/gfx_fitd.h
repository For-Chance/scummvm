...
#ifndef FREESCAPE_GFX_FITD_H
#define FREESCAPE_GFX_FITD_H
...
class FitdRenderer : public Renderer {
public:
	FitdRenderer(int screenW, int screenH, Common::RenderMode renderMode);
	virtual ~FitdRenderer();
	...
	Fitd3DTexture *_stippleTexture;
	Common::HashMap<uint64, Fitd3DTexture *> _stippleTextureCache;
